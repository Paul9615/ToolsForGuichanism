...
Source code는 본 directory의 src 폴더에 있습니다.
...
- file name: `translator.ahk`
- shortcut: `alt+shift+t`
- 맨날 papago 따로 틀기 귀찮아서 올ㅋ사전을 papago 버전으로 만들었음
- 물론 올ㅋ사전 코드에 papgo link를 copy&paste해서 만듦(5초컷)
- ~~근데 창이 너무 커서 수정 중임~~
- 수정: papago 번역질이 안 좋아서 google translator로 변경함

## 적용 방법

1. Auto Hot Key 설치(ver. 2.0.xx) [[link]](https://www.autohotkey.com/)
2. `win+R` 로 __실행__ 켜기
3. 실행 창에 `shell:startup` 입력 후 enter(시작 프로그램 폴더 열기)
4. 파일을 startup 창에 `exe` 파일들을 copy & paste
